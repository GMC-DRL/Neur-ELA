...
class RL_DAS_FE_Optimizer(Learnable_Optimizer):
    def __init__(self, config, fe):
    ...
    def observe(self):
        ...
        state = {'feature': feature, 'move': move, 'x': self.population.group, 'y': self.population.cost}
        return state
